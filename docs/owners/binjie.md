...
**Components:** model adapters (Claude / GPT / Gemini / Wafer / Grok), fillers (coding / Q&A).
...
class Model(Protocol):
    model_name: str
    provider: str  # "anthropic" | "openai" | "google" | "wafer" | "xai" — Shreyas needs this for per-provider semaphores
